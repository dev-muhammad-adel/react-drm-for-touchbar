...
export function Loader({ width = 120, height = 60 }: LoaderProps) {
  ...
  const src = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 150"><path fill="none" stroke="#FFFFFF" stroke-width="6" stroke-linecap="round" stroke-dasharray="300 385" stroke-dashoffset="${offset}" d="M275 75c0 31-27 50-50 50-58 0-92-100-150-100-28 0-50 22-50 50s23 50 50 50c58 0 92-100 150-100 24 0 50 19 50 50Z"/></svg>`;
